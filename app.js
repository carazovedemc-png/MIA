...
class TerminalBoot {
    ...
    showSocialAuthButtons() {
        ...
        setTimeout(() => {
            ...
            elements.socialAuthButtons.style.display = 'flex';
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    elements.socialAuthButtons.style.transition = 'all 0.3s ease';
    ...
    hideSocialAuthButtons() {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                elements.authButton.style.transition = 'all 0.3s ease';
            }, 50);
        }, 250);
    }
